...
Исключено (уже есть): окна, терраса, наружные стены/кровля/фасад.
...
ws["A2"] = (
    "ТОЛЬКО ВНУТРЕННИЕ работы/материалы. Уже есть и НЕ включено: окна, витражи, терраса, "
    "наружный контур, кровля, фасад. Внутри — каркас перегородок. "
    "Отопление: электрические конвекторы. "
...
SECTIONS.append((
    "1. ОТДЕЛКА ПЕРЕГОРОДОК И СТЕН ИЗНУТРИ (каркас уже есть)",
    [
        ...
        ("Гипсокартон ГКЛ 12,5 мм (стены сухие)", 95, "м²", 320, 2.0, "обе стороны перегородок + внутр. сторона наружных стен"),
        ("Гипсокартон ГКЛВ 12,5 мм влагостойкий (с/у)", 28, "м²", 420, 0.5, "стены санузла"),
        ("Профиль/брусок доборный, саморезы, лента, уголки", 1, "компл.", 12000, 0.0, "крепёж к существующему каркасу"),
        ("Серпянка, шпаклёвка стартовая + финишная", 130, "м²", 180, 2.5, "стены под покраску"),
        ("Грунт глубокого проникновения", 130, "м²", 35, 0.3, ""),
        ("Краска интерьерная моющаяся (2 слоя)", 120, "м²", 220, 1.5, "гостиная, спальни, прихожая"),
        ("Уголки защитные ПВХ на внешние углы", 30, "м.п.", 90, 0.2, ""),
        ("Откосы внутренние на окна (сэндвич/ГКЛ+уголок)", 18, "м.п.", 450, 1.0, "окна уже стоят — только внутр. отделка откосов"),
        ("Подоконники ПВХ белые", 6, "м.п.", 1200, 0.5, "если ещё не установлены"),
    ],
))
...
SECTIONS.append((
    ...
    [
        ...
        ("Плинтус потолочный / галтель", 40, "м.п.", 180, 0.5, "периметр помещений"),
    ],
))
...
data_rows = [
    ...
    ("Смета включает", "Только внутренняя отделка + инженерия внутри + обстановка под посуточную"),
    ("Смета НЕ включает", "Окна, терраса, фасад, кровля, фундамент, наружные работы, стоимость монтажа"),
...
stages = [
    "1–3 дн: электрика черновая + вода/канализация + линии под конвекторы",
    "4–8 дн: обшивка перегородок/стен ГКЛ, потолки",
    "9–12 дн: шпаклёвка, откосы окон изнутри",
    "13–16 дн: с/у гидроизоляция + плитка + тёплый пол",
    "17–19 дн: покраска, ламинат, плинтуса",
    "20–22 дн: двери, чистовая электрика, конвекторы, сантехника",
